module aes_unit (
  ...
  always_comb begin
    if (en) begin
      case (bs)
        2'b00 : rs2_shift = 5'd0 ; // 8 * 0
        2'b01 : rs2_shift = 5'd8 ; // 8 * 1
        2'b10 : rs2_shift = 5'd16; // 8 * 2
        2'b11 : rs2_shift = 5'd24; // 8 * 3
      endcase
    end
    else begin
      rs2_shift = 5'd0;
  ...
  assign rs2_int       = rs2 & {32{en}};
  assign selected_byte = rs2_int >> rs2_shift;

  // assign selected_byte = rs2_int >> (8 * bs);
