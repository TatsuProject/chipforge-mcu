...
module clmul (
    ...
    generate
        for (i = 0; i < 32; i++) begin : gen_partial_products
            assign pp[i] = rs2[i] ? ({32'b0, rs1} << i) : 64'b0;
        end
    endgenerate
...
module xperm4 (
    ...
    assign nibble[0] = rs1[3:0];
    assign nibble[1] = rs1[7:4];
    assign nibble[2] = rs1[11:8];
    assign nibble[3] = rs1[15:12];
    assign nibble[4] = rs1[19:16];
    assign nibble[5] = rs1[23:20];
    assign nibble[6] = rs1[27:24];
    assign nibble[7] = rs1[31:28];
...
module xperm8 (
    ...
    assign byte_in[0] = rs1[7:0];
    assign byte_in[1] = rs1[15:8];
    assign byte_in[2] = rs1[23:16];
    assign byte_in[3] = rs1[31:24];
...
module sha256sig0(
    ...
    assign ror7  = (rs1 >> 7)  | (rs1 << 25);
    assign ror18 = (rs1 >> 18) | (rs1 << 14);
    assign shr3  = rs1 >> 3;
...
module sha256sig1(
    ...
    assign ror17 = (rs1 >> 17) | (rs1 << 15);
    assign ror19 = (rs1 >> 19) | (rs1 << 13);
    assign shr10 = rs1 >> 10;
...
module sha256sum0(
    ...
    assign ror2  = (rs1 >> 2)  | (rs1 << 30);
    assign ror13 = (rs1 >> 13) | (rs1 << 19);
    assign ror22 = (rs1 >> 22) | (rs1 << 10);
...
module sha256sum1(
    ...
    assign ror6  = (rs1 >> 6)  | (rs1 << 26);
    assign ror11 = (rs1 >> 11) | (rs1 << 21);
    assign ror25 = (rs1 >> 25) | (rs1 << 7);
